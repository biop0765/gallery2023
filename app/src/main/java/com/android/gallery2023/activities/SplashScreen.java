...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "com.android.gallery2023.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.android.gallery2023.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.android.gallery2023.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.android.gallery2023.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
