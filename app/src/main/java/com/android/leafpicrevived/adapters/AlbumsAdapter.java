package com.android.leafpicrevived.adapters;
...
import com.android.leafpicrevived.CardViewStyle;
...
import com.android.leafpicrevived.data.sort.AlbumsComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(com.android.leafpicrevived.R.drawable.ic_error)
