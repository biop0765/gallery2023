...
import com.android.leafpicrevived.settings.CardViewStyleSetting;
import com.android.leafpicrevived.settings.ColorsSetting;
import com.android.leafpicrevived.settings.GeneralSetting;
import com.android.leafpicrevived.settings.MapProviderSetting;
import com.android.leafpicrevived.settings.SinglePhotoSetting;
import com.android.leafpicrevived.util.Security;
import com.android.leafpicrevived.views.SettingWithSwitchView;
...
public class SettingsActivity extends BaseActivity {
    ...
    public void updateUiElements() {
        ...
        findViewById(com.android.leafpicrevived.R.id.setting_background).setBackgroundColor(getBackgroundColor());
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(com.android.leafpicrevived.R.string.settings));
    }
