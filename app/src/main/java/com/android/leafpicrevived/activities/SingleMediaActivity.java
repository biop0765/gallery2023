...
import com.android.leafpicrevived.SelectAlbumBuilder;
import com.android.leafpicrevived.activities.base.SharedMediaActivity;
import com.android.leafpicrevived.adapters.MediaPagerAdapter;
import com.android.leafpicrevived.animations.SlidePageTransformer;
import com.android.leafpicrevived.data.Album;
import com.android.leafpicrevived.data.AlbumSettings;
import com.android.leafpicrevived.data.Media;
import com.android.leafpicrevived.data.MediaHelper;
import com.android.leafpicrevived.data.StorageHelper;
import com.android.leafpicrevived.data.filter.MediaFilter;
import com.android.leafpicrevived.data.provider.CPHelper;
import com.android.leafpicrevived.data.sort.MediaComparators;
import com.android.leafpicrevived.fragments.BaseMediaFragment;
import com.android.leafpicrevived.fragments.ImageFragment;
import com.android.leafpicrevived.util.AlertDialogsHelper;
import com.android.leafpicrevived.util.AnimationUtils;
import com.android.leafpicrevived.util.DeviceUtils;
import com.android.leafpicrevived.util.LegacyCompatFileProvider;
import com.android.leafpicrevived.util.Measure;
...
import com.android.leafpicrevived.views.HackyViewPager;
...
public class SingleMediaActivity extends SharedMediaActivity implements BaseMediaFragment.MediaTapListener {
    ...
    public static final String ACTION_OPEN_ALBUM = "com.android.leafpicrevived.intent.VIEW_ALBUM";
    public static final String ACTION_OPEN_ALBUM_LAZY = "com.android.leafpicrevived.intent.VIEW_ALBUM_LAZY";
