...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "com.android.leafpicrevived.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.android.leafpicrevived.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.android.leafpicrevived.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.android.leafpicrevived.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
